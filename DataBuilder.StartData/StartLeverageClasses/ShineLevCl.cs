...
namespace DataBuilder.StartData
{
    public class ShineLevCl : LeverageClassBase
    {
        ...
        public override string UniversalName => StartEffectsUniversalNames.Shine;

        public override string RussianName => StartEffectsRussianNames.Shine;

        public override Description Description => new();

        public override Guid StorageId => new("A7386483-8D22-465F-9793-5B0FCE213A14");
    }
}
