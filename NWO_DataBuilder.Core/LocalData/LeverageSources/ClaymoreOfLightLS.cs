...
namespace  NWO_DataBuilder.Core.LocalData.LeverageSources
{
    public class ClaymoreOfLightLS : LeverageSourceBase
    {
        ...
        public override string RussianName => "Клеймор света";
        ...
        public override Guid StorageId => new("49686B3C-A9B6-4A4E-8651-2ABAD42D06B75");

        public ClaymoreOfLightLS(ILeverage mainLeverage, params ILeverage[] additionalLeverages) : base(mainLeverage, additionalLeverages)
        {
        }
    }
}
