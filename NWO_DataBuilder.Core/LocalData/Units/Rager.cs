        ...
        public override List<IUnitLeveragesSource> CreateLeveragesSources()
        {
            ...
            return _leveragesSources = new()
            {
                new UnitLeveragesSource(flamingAxe, SkillPriority.PrimalPriority,
                    new LeverageInstantStrike(minValue: 50, maxValue: 55, cooldown: 8),
                    new TargetPeriodicDamageEffect(flamingAxe.AdditionalLeverages![0], duration: 8, cooldown: 14, minValue: 10, maxValue: 12)),

                new UnitLeveragesSource(flamingBroadsword, SkillPriority.SecondaryPriority,
                    new LeverageInstantStrike(minValue: 35, maxValue: 38, cooldown: 3),
                    new TargetPeriodicDamageEffect(flamingBroadsword.AdditionalLeverages![0], duration: 3, cooldown: 6, minValue: 5, maxValue: 8)),

                new UnitLeveragesSource(allLSources[nameof(ExplosiveRoarLS)], SkillPriority.HighPriority,
                    new LeverageInstantStrike(minValue: 30, maxValue: 67, cooldown: 10)),

                new UnitLeveragesSource(allLSources[nameof(ShaftStrikeLS)], SkillPriority.MiddlePriority,
                    new LeverageInstantStrike(minValue: 13, maxValue: 18, cooldown: 4)),

                new UnitLeveragesSource(allLSources[nameof(ArmouredBodyLS)], SkillPriority.SubsidiaryPriority,
                    new LeverageInstantStrike(minValue: 10, maxValue: 20, cooldown: 5)),

                new UnitLeveragesSource(strikeWithFire, SkillPriority.BasePriority,
                    new LeverageInstantStrike(minValue: 5, maxValue: 8, cooldown: 3),
                    new TargetPeriodicDamageEffect(strikeWithFire.AdditionalLeverages![0], duration: 2, cooldown: 6, minValue: 2, maxValue: 5))
            };
        }
    }
}
